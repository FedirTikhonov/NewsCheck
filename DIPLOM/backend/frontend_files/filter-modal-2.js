document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.filterModalInitialized) {
        console.log('Filter modal already initialized, skipping...');
        return;
    }
    ...
    function initFilterModal() {
        ...
        console.log(`Found ${containers.length} checkbox containers`);
    ...
    function applyFilters() {
        ...
        // Add emotionality - now supporting multiple values
